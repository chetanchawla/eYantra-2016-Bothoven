...
void hit()
{
  ...
  else if ((Next_Pos == 97 || Next_Pos == 101 || Next_Pos == 105 || Next_Pos == 109 || Next_Pos == 113 || Next_Pos == 117) && number >= 24 /*&& Curr_Pos >= 97*/)
  {
    if (clockwise == 1) //Clockwise Direction
    {
      striking_right();
  ...
  else if ((Next_Pos >= 65 && Next_Pos <= 89) /*&& (Curr_Pos == 99 || Curr_Pos == 103 || Curr_Pos == 107 || Curr_Pos == 111 || Curr_Pos == 115 || Curr_Pos == 119)*/)
  {
    if (number == 25)
    {
