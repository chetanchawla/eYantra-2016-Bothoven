...
int indS;
int counter = 0;
int blast;                                                                 /*For obstacle avoidance when the otherbot is at its note*/
int same;
int flagg;       
/*
...
void hit()
{
  ...
  else if ((Next_Pos >= 65 && Next_Pos <= 89) /*&& (Curr_Pos == 99 || Curr_Pos == 103 || Curr_Pos == 107 || Curr_Pos == 111 || Curr_Pos == 115 || Curr_Pos == 119)*/)
  {
    if (number == 25)
    {
      if ((Curr_Pos == 'w' && Next_Pos == 'A') || (Curr_Pos == 'A' && Next_Pos == 'C') || (Curr_Pos == 'C' && Next_Pos == 'B'))
      {
        striking_left();
      }
      ...
      else if ((Curr_Pos == 'G' && Next_Pos == 'B') || (Curr_Pos == 'D' && Next_Pos == 'C') || (Curr_Pos == 'U' && Next_Pos == 'C'))
      {
        striking_middle();
      }
    }
    ...
    {
      if ((Curr_Pos == 'K' && Next_Pos == 'J') || (Curr_Pos == 'J' && Next_Pos == 'O') || (Curr_Pos == 'k' && Next_Pos == 'J') || (Curr_Pos == 'O' && Next_Pos == 'N') || (Curr_Pos == 'M' && Next_Pos == 'L') || (Curr_Pos == 'B' && Next_Pos == 'C') || (Curr_Pos == 'C' && Next_Pos == 'D'))
      {
        striking_left();
      }
      else if ((Curr_Pos == 'C' && Next_Pos == 'B') || (Curr_Pos == 'U' && Next_Pos == 'C') || (Curr_Pos == 'c' && Next_Pos == 'G') || (Curr_Pos == 'B' && Next_Pos == 'G') || (Curr_Pos == 'G' && Next_Pos == 'F') || (Curr_Pos == 'F' && Next_Pos == 'E'))
...
int Line_Follow_Forw()
{
  ...
  if (verify == 1)
  {
    if (analogRead(A6) <= 275)        //Proximity sensor value
    {
      obstacle = 1;
      Stop();
      return 2;
